import { View, Text, Modal, TextInput, StatusBar, SafeAreaView } from 'react-native'
import { useState, useRef } from 'react'
import CustomButton from './CustomButton'
import { OTPModalProps } from "@/types/type";

export default function OTPModal({ visible, onVerify, onClose }: OTPModalProps) {
  ...
  const handleVerify = () => {
    ...
    if (otpString.length === 6) {
      ...
      if (otpString === '123456') { // Replace with actual OTP verification logic
        onVerify(otpString)
      } else {
        setIsIncorrect(true)
      }
        ...
        <View className="flex-1 justify-center items-center px-4">
          <View className="bg-white p-6 rounded-2xl w-full max-w-[350px]">
            ...
            <CustomButton
              ...
              bgVariant={isIncorrect ? "danger" : "primary"}
              textVariant="primary"
